...
use crate::canvas::draw_block;

const SNAKE_COLOR: Color = [0.00, 0.40, 1.00,1.00];
...
impl Snake {
    ...
    pub fn forward(&mut self , dir: Option<Direction>) {
        ...
        let next_block = match self.direction {
            Direction::Up => Block {
                x: last_x,
                y: last_y - 1,
            },
    ...
    pub fn next_head(&self, dir: Option<Direction>) -> (i32,i32) {
        ...
        let mut moving_direction : Direction = self.direction;
        match dir {
    ...
    pub fn overlapping_tail(&self, x: i32, y: i32) -> bool {
        let mut ch = 0;
        for block in &self.body {
